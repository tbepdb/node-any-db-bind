...
(function () {
  ...
  Lexer = (function () {
    var BOOLEAN, DBLSTRING, VAR, LITERAL, MATH, MATH_MULTI, NUMBER, SEPARATOR, SQL_CONDITIONALS, SQL_FUNCTIONS, SQL_KEYWORDS, SQL_OPERATORS, SQL_SORT_ORDERS, STAR, STRING, WHITESPACE, STRING_OPERATION;
    ...
    Lexer.prototype.strOperationToken = function() {
      return this.tokenizeFromList('STRING_OPERATION', STRING_OPERATION) ;
    };
    ...
    Lexer.prototype.varToken = function() {
      return this.tokenizeFromRegex('VAR', VAR, 1, 0);
    };
